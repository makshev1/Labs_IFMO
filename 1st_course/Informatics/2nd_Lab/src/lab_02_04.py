...
season = input()  # Создайте строковую переменную season, заполнив ее названием текущего сезона, введенным с клавиатуры.
season = season.encode("utf-8")  # Смените кодировку данной строки на utf-8.
print("Encoding utf-8:\n", season)  # Выведите закодированное и декодированное значения на экран.
season = season.decode("utf-8")
print("Decoding utf-8:\n", season)  # Выведите закодированное и декодированное значения на экран.


#  Создайте переменную sh
sh = "When shall we three meet again; In thunder, lightning, or in rain?"
# Осуществите замену слов "thunder", "lightning" и "in rain" на подстроки "C", "Erlang" и "Java main" соответственно.
